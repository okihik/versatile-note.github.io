...
3.  **Maintain Optimal Inventory Levels:** Instead of fixed "safety stocks," the system aims to maintain a dynamic inventory level that minimizes holding costs while ensuring product availability.
