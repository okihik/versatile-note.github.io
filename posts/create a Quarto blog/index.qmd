...
This tutorial is based on [this website](https://quarto.org/docs/publishing/) and [this blog](https://lab-notes.hakyimlab.org/post/2023-09-15-howto-blog/#create-a-new-post).

The procedure for publishing a Quarto blog using GitHub Pages and GitHub Actions is as follows:

## 1. Project Creation in RStudio
...
-   Create a new public repository on GitHub with the same name as the RStudio project directory.

## 3. Pushing Local Project to GitHub
...
## 7. Monitoring Workflow and Visiting Site
