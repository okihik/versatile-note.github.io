...
1.  Established a project structure based on the **Toulmin model** ([Part 1](https://manus.im/app/link-to-first-post)).

2.  Gathered our **Evidence** (raw data and references) into the `1_evidence` directory ([Part 2](https://manus.im/app/link-to-second-post)).

3.  Built our **Warrant** by scripting the analysis and saving the outputs to the `2_warrantAndAnalysis/results` directory ([Part 3](https://manus.im/app/link-to-third-post)).
...
**What is `tinytex`?**
Created by Yihui Xie (the same author of `knitr`), `tinytex` is an R package that installs a lightweight, self-contained, and portable LaTeX distribution.
